...
public class OssGetAndUploadFile {
    ...
    private static String TAG = "OssGetAndUploadFile";
    ...
    public void show() {
        ...
        bucket = ossService.getOssBucket(OSSUtil.bucketName);
        src_file_dir = OSSUtil.srcFileDir;
    ...
    public void resumableUpload() {
        ...
        try {
            bigfFile.setUploadFilePath(src_file_dir + "file10m", "raw/binary");
